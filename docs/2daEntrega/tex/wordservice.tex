...
son los que se detallaron en la sección de Arquitectura:
\begin{itemize}
...
librería de documentos y el SearchEngine, y orquestar las relaciones entre ellos.
...
\begin{enumerate}
\item Agregar el documento a la Librería de Documentos.
\item Iniciar una sesión con el Indexador.
...
\item Una vez terminadas las frases del documentos, se cierra la sesión con el indexador.
\item Se devuelve el lexico completo del documento (incluyendo las stopwords).
\end{enumerate}

A continuación se muestra un diagrama de secuencia de este proceso.
