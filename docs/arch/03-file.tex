...
Esta clase no manejará directamente el acceso al archivo físico si no que delegará en un fino wrapper de la clase \textbf{RandomAccessFile} que se encargará del manejo de los datos en bloque.
En la siguiente imágen podemos observar la jerarquía de clases
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[scale=0.5]{img/ClassDiagramVariableLengthFileManager.png}
	\end{center}
