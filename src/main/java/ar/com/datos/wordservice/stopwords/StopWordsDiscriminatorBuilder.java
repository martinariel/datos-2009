...
public class StopWordsDiscriminatorBuilder {
	 ...
	 * @return
	 */
	public static StopWordsDiscriminator buildStopWords(String fileDirectory){
    	
    	Set<String> stopWords 			= new HashSet<String>();
    	List<List<String>> stopPhrases 	= new LinkedList<List<String>>();
    	Document stopWordsDocument		= new FileSystemDocument(fileDirectory + "stop_words.txt");
    	Document stopPhrasesDocument	= new FileSystemDocument(fileDirectory + "stop_phrases.txt");
