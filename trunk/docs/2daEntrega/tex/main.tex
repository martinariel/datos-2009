...
\include{crawler}          % Crawler, Discriminator
\include{indexer}          % Indexer, LexicalManager
\include{bsharptree}       % BSharp Tree
\include{searchengine}     % SearchEngine, Queries, FTRS
