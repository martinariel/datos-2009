...
\subsection{Limitaciones del Trie: Implementación en Disco}
...
\subsection{Diseño de un Trie Genérico}
...
El diseño conceptual de datos para los registros, queda:
\begin{verbatim}
...
El diseño lógico de datos para los registros, queda:
\begin{verbatim}
Arhivo de nodos internos:
