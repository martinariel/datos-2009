...
Se creó además un \textit{LzpSerializer} que utiliza para la deshidratación un \texit{LzpCompressor} y para la hidratación un \textit{LzpDeCompressor}. Ver diagrama LzpMainPicture.
