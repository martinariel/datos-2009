...
Se utilizará una entidad para abstraer a cada uno de los archivo, ambas entidades con el mismo comportamiento. Esta entidad se encarga permite tanto la carga de registros, como dos diferentes tipos de recuperación de registros (completa y secuencial, o, de un único registro y direccionada). 
