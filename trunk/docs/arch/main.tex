...
\begin{abstract}
Documentación técnica y descriptiva acerca del desarrollo de la primera entrega del TP de la materia 75.06 cátedra Servetto. El objetivo del TP es armar un sistema que permita la lectura de textos y la reproducción de la misma en audio. Los audios son agregados por el usuario y el sistema debe ser capaz de persistirlos y recuperarlos.
\it Documento desarrollado en LATEX.
\end{abstract}
