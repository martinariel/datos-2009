...
public class RootNodeSerializer<E extends Element<K>, K extends Key> implements Serializer<RootNodeDisk<E, K>> {
	 ...
	 * Configuraciones del árbol entre las cuales está la configuración del nodo.
	 */
	public RootNodeSerializer(ListKeysSerializer<K> listKeysSerializer, BTreeSharpConfigurationDisk<E, K> bTreeSharpConfigurationDisk) {
	 ...
	 */
	@Override
	public void dehydrate(OutputBuffer output, RootNodeDisk<E, K> object) {
	 ...
	 */
	@Override
	public RootNodeDisk<E, K> hydrate(InputBuffer input) {
		// Obtengo las keys
	 ...
	 */
	@Override
	public long getDehydrateSize(RootNodeDisk<E, K> object) {
